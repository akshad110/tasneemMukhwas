...
/** Fan spread around viewport center — symmetric left/center/right via xPercent + left-1/2 */
const FAN = [
...
export default function ProductPackets({ active = true }: ProductPacketsProps) {
